...
def get_competitors(primary_ticker):
    ...
    competitors_data = pd.read_csv("/Users/ajmalamir/Documents/New_yahoo_finance/Even_code Request/yahoo_finance/yahoo_finance/spiders/comeptitors.csv")
...
def main():
    ...
    competitors_df = pd.read_csv(
        '/Users/ajmalamir/Documents/New_yahoo_finance/Even_code Request/yahoo_finance/yahoo_finance/spiders/comeptitors.csv')
